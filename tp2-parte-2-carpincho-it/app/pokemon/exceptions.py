...
InvalidPokemonIntegranteApodo = HTTPException(
    status_code=400, detail="El apodo del integrante ya está registrado"
)
...
InvalidPokemonMovimiento = HTTPException(
    status_code=409, detail="El movimiento no pertence al pokemon"
)
